    ...
    public void run(String... args) {
        ...
        List<Book> seedBooks = List.of(
                ...
                Book.builder().title("The Great Gatsby").author("F. Scott Fitzgerald")
                        ...
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775234539/greaat_gatsby_cize2a.jpg")
                        .coverColor("#5d4037").spineColor("#3e2723").build(),
                Book.builder().title("To Kill a Mockingbird").author("Harper Lee")
                        ...
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775234539/mockingbird_se9pgv.jpg")
                        .coverColor("#5d4037").spineColor("#3e2723").build(),
                ...
                Book.builder().title("Fahrenheit 451").author("Ray Bradbury")
                        ...
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775234534/fahrenheit-451-46_rehdsg.jpg")
                        .coverColor("#5d4037").spineColor("#3e2723").build(),
                ...
                Book.builder().title("The Alchemist").author("Paulo Coelho")
                        ...
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775234536/The-Alchemist-001_lxgw0e.jpg")
                        .coverColor("#5d4037").spineColor("#3e2723").build(),
                Book.builder().title("Lord of the Flies").author("William Golding")
                        ...
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775234538/Lord_of_the_Flies_William_Golding_zkcmz7.jpg")
                        .coverColor("#5d4037").spineColor("#3e2723").build(),
                Book.builder().title("The Catcher in the Rye").author("J.D. Salinger")
                        ...
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775234541/The_Catcher_in_the_Rye_J.D._Salinger_dgrmlb.jpg")
                        .coverColor("#5d4037").spineColor("#3e2723").build(),
                Book.builder().title("Project Hail Mary").author("Andy Weir")
                        .description("A lone astronaut must save the earth from disaster.")
                        .pages(476).rating(5.0).copiesAvailable(3).badge("EXCLUSIVE")
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775234545/Project_Hail_Mary_Andy_Weir_obafkm.jpg")
                ...
                Book.builder().title("Circe").author("Madeline Miller")
                        ...
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775234535/Circe_Madeline_Miller_mrccqj.jpg")
                        .coverColor("#1a1a2e").spineColor("#0f0f1a").build(),
                Book.builder().title("Dune").author("Frank Herbert")
                        ...
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775234540/Dune_Frank_Herbert_moajut.jpg")
                        .coverColor("#1a1a2e").spineColor("#0f0f1a").build(),
                Book.builder().title("Neuromancer").author("William Gibson")
                        ...
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775234541/Neuromancer_William_Gibson_c5kg6o.jpg")
                        .coverColor("#1a1a2e").spineColor("#0f0f1a").build(),
                Book.builder().title("American Gods").author("Neil Gaiman")
                        ...
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775234532/American_Gods_Neil_Gaiman_ozfgjf.jpg")
                        .coverColor("#1a1a2e").spineColor("#0f0f1a").build(),
                Book.builder().title("A Game of Thrones").author("George R.R. Martin")
                        .description("Winter is coming.")
                        .pages(694).rating(4.9).copiesAvailable(4).badge("PREMIUM")
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775234530/A_Game_of_Thrones_George_R.R._Martin_vfzzay.jpg")
                        .coverColor("#1a1a2e").spineColor("#0f0f1a").build(),
                ...
                Book.builder().title("The Name of the Wind").author("Patrick Rothfuss")
                        ...
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775234530/The_Name_of_the_Wind_cphkad.jpg")
                        .coverColor("#1a1a2e").spineColor("#0f0f1a").build(),
                ...
                Book.builder().title("The Shadow of the Wind").author("Carlos Ruiz Zafon")
                        ...
                        .imageUrl(
                                "https://res.cloudinary.com/df8aj6mzn/image/upload/v1775288991/teborveedmkpps2iuzbo.jpg")
                        .coverColor("#1a1a2e").spineColor("#0f0f1a").build(),
